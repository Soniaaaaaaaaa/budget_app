...
CREATE TABLE member (
    ...
    CONSTRAINT `fk_group_id` FOREIGN KEY (`group_id`) REFERENCES `group_info` (`group_id`),
...
INSERT INTO user (email, password, username) VALUES ('sofayankovich0106@gmail.com', 'admin123', 'Sofiiaaa');
INSERT INTO member (user_id, group_id, user_role) VALUES (
    (SELECT user_id FROM user WHERE email = 'sofayankovich0106@gmail.com'),
    (SELECT group_id FROM group_info WHERE group_name = 'personal'),
	 'owner'
);
